...
<html lang="en-us">
<head>
<title>Example: Manage Document Metadata</title>
...
<div class="code-links"><a href="example_meta_display.php">Display code</a> | <strong>Execute code</strong></div>

<pre>
<?php
// MarkLogic REST documentation for metadata loading: http://docs.marklogic.com/guide/rest-dev/documents#id_83210
...
// Properties
$properties = array('size' => 'large', 'color' => 'blue', 'qty' => 12);	// Define an associative array of properties
...
$permission3 = new Permission('doc-editor', 			// Create a new Permission object for doc-editor
                              array('read', 'update'));
$meta1->addPermissions($permission3);					// Add the permission to the metadata object
...
// Update metadata via document write
