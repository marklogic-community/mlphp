...
<html lang="en-us">
<head>
<title>Example: Define Search Options</title>
...
<div class="code-links"><a href="example_opts_display.php">Display code</a> | <strong>Execute code</strong></div>

<pre>
<?php
// MarkLogic REST documentation for XML search options: http://docs.marklogic.com/guide/rest-dev/appendixb#chapter
...
$options2 = new Options($client);	// Create an Options object (passing the REST client object)
...
$pref2 = new PreferredElement('personal',							// Set element name
                              'http://marklogic.com/wikipedia');	// Set element namespace
$transform2->addPreferredElements(array($pref1, $pref2));	//Add to TransformResults object
$options2->setTransformResults($transform2);				//Add to Options object
...
// Word constraint and a search-option
$options3 = new Options($client);								// Create an Options object (passing the REST client object)
