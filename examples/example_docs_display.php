...
<html lang="en-us">
<head>
<title>Example Code: Read/Write/Delete Documents</title>
...
<div class="code-links"><strong>Display code</strong> | <a href="example_docs.php">Execute code</a></div>
...
<span class="code-section">// Text as a document</span>
...
<span class="code-section">// XML file</span>
...
<span class="code-section">// JSON file</span>
...
<span class="code-section">// Binary image file</span>
...
<span class="code-section">// Binary PDF file</span>
...
<span class="code-section">// Files from a directory</span>
...
<span class="code-section">// Delete a document</span>
