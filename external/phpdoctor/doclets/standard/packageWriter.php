...
class PackageWriter extends HTMLWriter
{
    ...
    function packageWriter(&$doclet)
    {
        ...
        foreach($packages as $packageName => $package) {
            ...
            $this->_sections[0] = array('title' => 'Overview', 'url' => 'overview-summary.html');
            //$this->_sections[1] = array('title' => 'Namespace', 'selected' => TRUE); // Package not Namespace
            ...
            if ($displayTree) {
                ...
                $this->_sections[0] = array('title' => 'Overview', 'url' => 'overview-summary.html');
                //$this->_sections[1] = array('title' => 'Namespace', 'url' => $package->asPath().'/package-summary.html', 'relative' => TRUE); // Package not Namespace
